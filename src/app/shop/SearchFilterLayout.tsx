...
export default function SearchFilterLayout({
  ...
  return (
    <main className="group flex flex-col items-center gap-10 px-5 py-10 lg:flex-row lg:items-start">
  ...
  return (
    <div className="space-y-3">
      ...
      {selectedCollectionIds.length>0 && (
        <button onClick={()=> updateCollectionIds([])}
...
function PriceFilter({minDefaultInput, maxDefaultInput, updatePriceRange}: PriceFilterProps){
...
function SortFilter({sort, updateSort}: SortFilterProps){
    return(
        <Select value={sort || "last_updated"} onValueChange={updateSort}>
            ...
            <SelectContent>
                <SelectItem value={"last_updated"}>Latest</SelectItem>
