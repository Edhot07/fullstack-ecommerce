...
async function ProductResults({ q, page, collectionIds, priceMin, priceMax, sort }: ProductResultsProps) {
  ...
  return (
    <div className="space-y-10 group-has-[[data-pending]]:animate-pulse">
      ...
      <div className="grid-cols-2 flex flex-col gap-5 sm:grid xl:grid-cols-3 2xl:grid-cols-4">
