...
export async function generateMetadata({ params: { slug }, searchParams: {page} }: PageProps): Promise<Metadata> {
...
export default async function Page({ params: { slug }, searchParams: {page="1"} }: PageProps) {
  const collection = await getCollectionBySlug(getWixServerClient(), slug);
